...
import dev.dworks.apps.asecure.R;
...
public class CallerInfo {
    ...
    public static CallerInfo getCallerInfo(Context context, String number) {
        ...
        if (dev.dworks.apps.asecure.blacklist.PhoneNumberUtils.isLocalEmergencyNumber(number, context)) {
            return new CallerInfo().markAsEmergency(context);
        } else if (dev.dworks.apps.asecure.blacklist.PhoneNumberUtils.isVoiceMailNumber(number, context)) {
    ...
    static CallerInfo doSecondaryLookupIfNecessary(Context context,
        ...
        if (!previousResult.contactExists
                && dev.dworks.apps.asecure.blacklist.PhoneNumberUtils.isUriNumber(number)) {
            String username = dev.dworks.apps.asecure.blacklist.PhoneNumberUtils.getUsernameFromUriNumber(number);
    ...
    /* package */ CallerInfo markAsEmergency(Context context) {
        phoneNumber = "Emergency"; //context.getString(
         //android.R.string.emergency_call_dialog_number_for_display);
